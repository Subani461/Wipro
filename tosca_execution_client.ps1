...
param(
    ...
    [string]$toscaServerUrl="https://ttosca.azure.uniper.energy:443",
    [string]$executionEnvironment = "Dex",
    [string]$projectName="Uniper_Project",
    [string]$events='["TestEvent2"]' ,
    [string]$eventsConfigFilePath,
    
    #Optional parameters
    [string]$clientId="4k-ILLNADk-kd98HbEGBTA",
    [string]$clientSecret="ISj8nrM1IEWLEqiXRMMU0gZzogHIMZQUKVLoIH1WhggQ",
