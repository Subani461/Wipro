...
public class ReportGenerator extends screenshots{
    ...
    public static void startReport() {
        if (extent == null) {
            extent = new ExtentReports("C:\\Users\\Administrator\\eclipse-workspace\\BookingApplication\\src\\test\\resources\\Reports\\Report1.html",true);
        }
    }
